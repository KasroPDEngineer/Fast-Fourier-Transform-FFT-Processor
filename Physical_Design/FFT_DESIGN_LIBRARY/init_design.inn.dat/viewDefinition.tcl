...
create_constraint_mode -name functional_fft_slow\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/FFT_slow_sdc.sdc]
create_constraint_mode -name functional_fft_fast\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/FFT_fast_sdc.sdc]
create_analysis_view -name view_fft_fast -constraint_mode functional_fft_fast -delay_corner delay_corner_fft_fast
create_analysis_view -name view_fft_slow -constraint_mode functional_fft_slow -delay_corner delay_corner_fft_slow
