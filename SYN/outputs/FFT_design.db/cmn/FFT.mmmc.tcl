#################################################################################
#
# Created by Genus(TM) Synthesis Solution 21.18-s082_1 on Mon Oct 27 16:13:50 EDT 2025
#
#################################################################################

## library_sets
create_library_set -name default_emulate_libset_max \
    -timing { /home/vlsitech_01/Cadence-RTL-to-GDSII-Flow-main/LIB//slow_vdd1v0_basiccells.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { ../SYN/outputs/FFT_design.db/cmn/FFT.mmmc/modes/default_emulate_constraint_mode/default_emulate_constraint_mode.sdc.gz }
